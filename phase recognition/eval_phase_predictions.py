...
ZEROSHOT_PRED = DATA_DIR / "outputs" / "zeroshot_predictions.jsonl"
FINETUNE_PRED = DATA_DIR / "outputs" / "finetuned_predictions.jsonl"
ZEROSHOT_OUT = BASE_DIR / "outputs" / "eval_zeroshot_phase"
FINETUNE_OUT = BASE_DIR / "outputs" / "eval_finetuned_phase"
